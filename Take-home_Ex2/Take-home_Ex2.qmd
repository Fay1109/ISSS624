...
pacman::p_load(sf, tidyverse, tmap, funModeling, sfdep, rgeoda, corrplot, cluster, NbClust, knitr)
```
...
cluster_vars <- nigeria_wp %>%
  ...
  select('ADM2_EN','wpt_functional','wpt_nonfunctional','pct_functional''pct_nonfunctional''pct_handpump','pct_usage_above_1k','pct_rural')
head(cluster_vars,3)
```
